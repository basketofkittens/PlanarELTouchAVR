...
#EXTRAINCDIRS = ~/Dropbox/ETA/AVR-ny/ispplattatest
...
-Wall -Wstrict-prototypes -DF_CPU=8000000UL
-Wa,-adhlns=$(<:.c=.lst) \
...
AVRDUDE_FLAGS = -p $(MCU) -P $(AVRDUDE_PORT) -c $(AVRDUDE_PROGRAMMER) #-b $(BAUD)
